...
import AltanaHirePanel from '@/app/components/AltanaHirePanel'
export default async function AgentPage({params}:{params:{id:string}}){
  ...
  return (<main className="py-6">
    ...
    <div className="card p-6 mt-4">
      ...
      <AltanaHirePanel agentId={a.id} price={a.price} />
      <p className="text-xs text-[#8C8F9B] mt-3">Altana session: agent-owned wallet · spend cap onchain · expiry + revocation visible. Tx verifiable in Altana explorer (testnet ok, mainnet stronger). PancakeSwap: non-custodial swaps. Links open at testnet.altana.network → account/key.</p>
    </div>
